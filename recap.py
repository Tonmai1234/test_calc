...
class MyCalculator:
    def __init__(self):
        ...
        self.label = tk.Label(self.root, text="Calculator DIP 02", font=('Kanit Medium',18), fg="white", bg="black")
        self.label.pack()
        ...
        self.button = tk.Button(self.root, text="/", height=4, width=8, font=('Kanit Medium', 10), fg="white", bg="#ff962e")
        ...
        self.button = tk.Button(self.root, text="x", height=4, width=8, font=('Kanit Medium', 10), fg="white", bg="#ff962e")
